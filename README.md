...
- [关键逻辑设计](#关键逻辑设计)
    - [编译与运行BPF](#编译与运行BPF)
    - [启动逻辑](#启动逻辑)
        - [创建package + 编译](#创建package+编译)
        - [挂载](#挂载)
        - [创建instance + 运行](#创建instance+运行)
- [运行与效果](#运行与效果)
    - [编译运行](#编译运行)
    - [指令说明](#指令说明)
    - [运行示例](#运行示例)
...
- [遇到的问题与解决](#遇到的问题与解决)
    - [设计上的问题](#设计上的问题)
        - [编译运行BPF的过程](#编译运行BPF的过程)
        - [集群中BPF相关资源的管理](#集群中BPF相关资源的管理)
        - [指令实现相关的问题](#指令实现相关的问题)
    - [运行环境上的问题](#运行环境上的问题)
...
#### Kubernetes资源<a name="Kubernetes资源"></a>
...
## 关键逻辑设计<a name="关键逻辑设计"></a>

#### 编译与运行BPF<a name="编译与运行BPF"></a>
...
##### 创建package + 编译<a name="创建package+编译"></a>
...
##### 创建instance + 运行<a name="创建instance+运行"></a>
...
## 遇到的问题与解决<a name="遇到的问题与解决"></a>

#### 设计上的问题<a name="设计上的问题"></a>

##### 1、编译运行BPF的过程<a name="编译运行BPF的过程"></a>
...
##### 2、集群中bpf相关资源的管理<a name="集群中bpf相关资源的管理"></a>
...
##### 3、指令实现相关的问题<a name="指令实现相关的问题"></a>
